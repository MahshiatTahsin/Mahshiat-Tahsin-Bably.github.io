...
### Digital Content Visualizer  
**Guerniss, Dhaka, Bangladesh**  
**Nov 2023 – Mar 2024**

- Created and supported digital content for online platforms.
- Worked with visual content, branding ideas, and creative communication.
- Gained practical experience in content creation, social media, design, and digital presentation.

### Trainee Engineer  
**Confidence Electro-Mech Ltd., Dhaka, Bangladesh**  
**Dec 2022 – Sep 2023**

- Worked in a technical engineering environment.
- Supported engineering-related tasks and learned practical workplace processes.
- Developed professional skills in communication, teamwork, technical documentation, and problem-solving.

## Technical Skills

- **Programming:** Python, C, Java, Shell Scripting
- **AI & Data:** Artificial Intelligence, Machine Learning, Data Science, Power BI, Data Cleaning, Data Structuring, Data Transformation
- **Web Development:** Frontend Development, Web Technologies, Design Patterns
- **Software Engineering:** Software Testing, Test Plans, Test Scenarios, Reports
- **Design & Content:** Graphic Design, Video Editing, Digital Content Creation
- **Tools & Simulation:** Matlab, Cisco Packet Tracer, Proteus, TinkerCad
